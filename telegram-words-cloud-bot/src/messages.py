...
ERROR_MESSAGE = \
    {
        "ru": """Что-то пошло не так. Проверьте, что вы отправили нужный файл и попробуйте еще раз. Если ошибка повторяется - 
    напишите @STmihan """,
        "en": """Something went wrong. Check that you sent the right file and try again. If the error persists -
    write @STmihan """,
        "ua": """Щось пішло не так. Перевірте, що ви надіслали потрібний файл і спробуйте ще раз. Якщо помилка повторюється -
    напишіть @STmihan """,
    }
